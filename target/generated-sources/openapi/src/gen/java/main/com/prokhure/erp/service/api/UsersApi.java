...
import com.prokhure.erp.service.model.UsersListResponse;
...
public interface UsersApi {
    ...
    /**
     * GET /user/list : Get all users in the system
     * get users paginated by role or date created
     *
     * @param page page number (required)
     * @param pageSize page size (required)
     * @param role The user role (optional)
     * @param dateCreated Date user was created (optional)
    ...
    @Operation(
        ...
        description = "get users paginated by role or date created",
        tags = { "users" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = UsersListResponse.class))
            }),
    ...
    default ResponseEntity<UsersListResponse> listUsers(
        ...
        @Parameter(name = "role", description = "The user role", in = ParameterIn.QUERY) @Valid @RequestParam(value = "role", required = false) String role,
        @Parameter(name = "dateCreated", description = "Date user was created", in = ParameterIn.QUERY) @Valid @RequestParam(value = "dateCreated", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date dateCreated
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"data\" : { \"pageInfo\" : { \"totalItems\" : 0, \"totalPages\" : 6 }, \"users\" : [ { \"businessRegNumber\" : \"businessRegNumber\", \"businessDesc\" : \"businessDesc\", \"isEmailVerified\" : true, \"phoneNumber\" : \"phoneNumber\", \"dateCreated\" : \"2000-01-23T04:56:07.000+00:00\", \"phoneCountryCode\" : \"phoneCountryCode\", \"businessCategory\" : \"businessCategory\", \"name\" : \"name\", \"userUuid\" : \"userUuid\", \"verifiedById\" : \"verifiedById\", \"businessType\" : \"businessType\", \"userRole\" : \"userRole\", \"email\" : \"email\", \"isBusinessVerified\" : true, \"status\" : \"status\" }, { \"businessRegNumber\" : \"businessRegNumber\", \"businessDesc\" : \"businessDesc\", \"isEmailVerified\" : true, \"phoneNumber\" : \"phoneNumber\", \"dateCreated\" : \"2000-01-23T04:56:07.000+00:00\", \"phoneCountryCode\" : \"phoneCountryCode\", \"businessCategory\" : \"businessCategory\", \"name\" : \"name\", \"userUuid\" : \"userUuid\", \"verifiedById\" : \"verifiedById\", \"businessType\" : \"businessType\", \"userRole\" : \"userRole\", \"email\" : \"email\", \"isBusinessVerified\" : true, \"status\" : \"status\" } ] }, \"description\" : \"successful\", \"status\" : \"00\" }";
