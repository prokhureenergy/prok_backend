...
public class BankDetailResponse {
  ...
  public BankDetailResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public BankDetailResponse description(String description) {
  ...
  */
  ...
  public BankDetailResponse data(BankDetail data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    BankDetailResponse bankDetailResponse = (BankDetailResponse) o;
    return Objects.equals(this.status, bankDetailResponse.status) &&
        Objects.equals(this.description, bankDetailResponse.description) &&
        Objects.equals(this.data, bankDetailResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankDetailResponse {\n");
